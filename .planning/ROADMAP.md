...
- [ ] 03-02-PLAN.md — Tax page UI: capital gains summary card, compliance vault, FY toggle
...
- [x] 05-04-PLAN.md — Zerodha Kite Connect: kite-holdings-mapper TDD, OAuth callback route, Broker tab on import page
